...
public class WimjetFastRenderView extends SurfaceView implements Runnable {
	private WimjetGame game;
	private Bitmap framebuffer;
	private Thread renderThread;
	private SurfaceHolder holder;
	private volatile boolean running;

	public WimjetFastRenderView(Context context) {
		super(context);
	}

	public WimjetFastRenderView(WimjetGame game, Bitmap framebuffer) {
		this(game);
		this.game = game;
