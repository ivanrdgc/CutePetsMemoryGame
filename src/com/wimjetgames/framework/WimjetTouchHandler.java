...
import com.wimjetgames.framework.WimjetInput.WimjetTouchEvent;
import com.wimjetgames.framework.WimjetPool.PoolObjectFactory;

public class WimjetTouchHandler implements OnTouchListener {
	...
	private int[] touchY;
	private int[] id;
	private WimjetPool<WimjetTouchEvent> touchEventPool;
	private List<WimjetTouchEvent> touchEvents;
	private List<WimjetTouchEvent> touchEventsBuffer;
	private float scaleX;
	private float scaleY;

	public WimjetTouchHandler(View view, float scaleX, float scaleY) {
		...
		this.touchEventPool = new WimjetPool<WimjetTouchEvent>(factory, 100);
